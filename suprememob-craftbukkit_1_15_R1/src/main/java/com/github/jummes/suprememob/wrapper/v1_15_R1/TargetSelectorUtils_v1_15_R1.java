...
public class TargetSelectorUtils_v1_15_R1 implements TargetSelectorUtils {
    ...
    public void setNearestEntityTarget(Mob mob, EntityType type, Predicate<LivingEntity> entityPredicate, int randomInterval, boolean mustSee, boolean mustReach) {
        ...
        entity.targetSelector.a(nextId(entity.targetSelector.c()), new PathfinderGoalNearestAttackableTarget<>(entity,
